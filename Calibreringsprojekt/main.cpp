...
int main(int argc, char **argv) {
    ...
    /*    funktioner der skal indsættes
  cv::calibrateCamera(object_points, image_points, image_size, camera_matrix, distortion_koefficients, rotation_vectors, translation_vectors);
  cv::undistort(camera_image, corrected_image, camera_matrix, distortion_koeficients);
  */
    /*
   * Troede at cv::undistort skulle bruges her men det skal den vist ikke???
   * SPØRG THORBJØRN!!!
   * */
    ...
    std::ofstream file("Kalibreringsfil.txt");

    file << "Reprojection error = " << error << "\nK =\n"
         << K << "\nk=\n"
         << k << std::endl;
